...
var DefaultApi = /** @class */ (function () {
     ...
     */
    DefaultApi.prototype.addFeature1 = function (did, wvm, wvmid, eid, body) {
     ...
     */
    DefaultApi.prototype.createPartStudio = function (did, wid, bTModelElementParams) {
     ...
     */
    DefaultApi.prototype.exportPS1 = function (did, wvm, wvmid, eid, partIds, version, includeExportIds, configuration, linkDocumentId) {
     ...
     * @param linkDocumentId Id of document that links to the document being accessed. This may provide additional access rights to the document. Allowed only with version (v) path parameter.
     */
    DefaultApi.prototype.exportStl1 = function (did, wvm, wvmid, eid, partIds, mode, grouping, scale, units, angleTolerance, chordTolerance, maxFacetWidth, minFacetWidth, configuration, linkDocumentId) {
     ...
     * @param linkDocumentId Id of document that links to the document being accessed. This may provide additional access rights to the document. Allowed only with version (v) path parameter.
     */
    DefaultApi.prototype.getBodyDetails2 = function (did, wvm, wvmid, eid, configuration, linkDocumentId) {
     ...
     * @param linkDocumentId Id of document that links to the document being accessed. This may provide additional access rights to the document. Allowed only with version (v) path parameter.
     */
    DefaultApi.prototype.getBoundingBoxes2 = function (did, wvm, wvmid, eid, includeHidden, includeWireBodies, configuration, linkDocumentId) {
     ...
     */
    DefaultApi.prototype.getEdges2 = function (did, wvm, wvmid, eid, angleTolerance, chordTolerance, partId, edgeId, configuration, linkDocumentId) {
     ...
     * @param linkDocumentId Id of document that links to the document being accessed. This may provide additional access rights to the document. Allowed only with version (v) path parameter.
     */
    DefaultApi.prototype.getFaces2 = function (did, wvm, wvmid, eid, angleTolerance, chordTolerance, maxFacetWidth, outputVertexNormals, outputFacetNormals, outputTextureCoordinates, outputIndexTable, partId, faceId, outputErrorFaces, configuration, linkDocumentId) {
     ...
     */
    DefaultApi.prototype.getFeatures = function (did, wvm, wvmid, eid, featureId, linkDocumentId, noSketchGeometry) {
        var localVarPath = this.basePath + '/api/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/features'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
            .replace('{' + 'wvmid' + '}', encodeURIComponent(String(wvmid)))
     ...
     * @param linkDocumentId Id of document that links to the document being accessed. This may provide additional access rights to the document. Allowed only with version (v) path parameter.
     */
    DefaultApi.prototype.getMassProperties = function (did, wvm, wvmid, eid, partId, massAsGroup, configuration, linkDocumentId) {
     ...
     */
    DefaultApi.prototype.getNamedViews2 = function (did, eid, skipPerspective) {
     ...
     * @param linkDocumentId Id of document that links to the document being accessed. This may provide additional access rights to the document. Allowed only with version (v) path parameter.
     */
    DefaultApi.prototype.getShadedViews1 = function (did, wvm, wvmid, eid, viewMatrix, outputHeight, outputWidth, pixelSize, edges, showAllParts, includeSurfaces, useAntiAliasing, configuration, linkDocumentId) {
     ...
     */
    DefaultApi.prototype.getTranslatorFormats4 = function (did, wid, eid, checkContent) {
     ...
     */
    DefaultApi.prototype.translateFormat5 = function (did, wv, wvid, eid, bTTranslateFormatParams) {
     ...
     */
    DefaultApi.prototype.translateIds1 = function (did, wvm, wvmid, eid, bTIdTranslationParams) {
