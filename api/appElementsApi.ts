...
export class AppElementsApi {
     ...
     */
    public commitTransaction (did: string, eid: string, wid: string, tid: string, bTAppElementCommitTransactionParams: BTAppElementCommitTransactionParams) : Promise<{ response: http.IncomingMessage; body: BTAppElementModifyInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTAppElementModifyInfo;  }>((resolve, reject) => {
     ...
     */
    public create7 (did: string, wid: string, bTAppElementParams: BTAppElementParams) : Promise<{ response: http.IncomingMessage; body: BTAppElementModifyInfo;  }> {
     ...
     */
    public createReference1 (did: string, eid: string, wvm: string, wvmid: string, bTAppElementReferenceParams: BTAppElementReferenceParams) : Promise<{ response: http.IncomingMessage; body: BTAppElementReferenceInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTAppElementReferenceInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param description 
     */
    public deleteContent1 (did: string, eid: string, wvm: string, wvmid: string, sid: string, transactionId?: string, parentChangeId?: string, description?: string) : Promise<{ response: http.IncomingMessage; body: BTAppElementModifyInfo;  }> {
     ...
     * @param description 
     */
    public deleteReference1 (did: string, eid: string, wvm: string, wvmid: string, rid: string, transactionId?: string, parentChangeId?: string, description?: string) : Promise<{ response: http.IncomingMessage; body: BTAppElementReferenceInfo;  }> {
     ...
     * @param wvmid 
     */
    public getHistory (did: string, eid: string, wvm: string, wvmid: string) : Promise<{ response: http.IncomingMessage; body: BTAppElementHistoryInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTAppElementHistoryInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getSubElementContent (did: string, eid: string, wvm: string, wvmid: string, transactionId?: string, changeId?: string, baseChangeId?: string, subelementId?: string, linkDocumentId?: string) : Promise<{ response: http.IncomingMessage; body: BTAppElementContentInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTAppElementContentInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param changeId 
     */
    public getSubelementIds (did: string, eid: string, wvm: string, wvmid: string, transactionId?: string, changeId?: string) : Promise<{ response: http.IncomingMessage; body: BTAppElementModifyInfo;  }> {
     ...
     * @param linkDocumentId 
     */
    public resolveReference1 (did: string, eid: string, wvm: string, wvmid: string, rid: string, transactionId?: string, parentChangeId?: string, includeInternal?: boolean, linkDocumentId?: string) : Promise<{ response: http.IncomingMessage; body: BTAppElementReferenceResolveInfo;  }> {
        const localVarPath = this.basePath + '/api/appelements/d/{did}/{wvm}/{wvmid}/e/{eid}/references/{rid}'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTAppElementReferenceResolveInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public startTransaction (did: string, eid: string, wid: string, bTAppElementStartTransactionParams: BTAppElementStartTransactionParams) : Promise<{ response: http.IncomingMessage; body: BTAppElementModifyInfo;  }> {
     ...
     */
    public update5 (did: string, eid: string, wvm: string, wvmid: string, bTAppElementUpdateParams: BTAppElementUpdateParams) : Promise<{ response: http.IncomingMessage; body: BTAppElementModifyInfo;  }> {
        const localVarPath = this.basePath + '/api/appelements/d/{did}/{wvm}/{wvmid}/e/{eid}/content'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
     ...
     * @param bTAppElementReferenceParams 
     */
    public updateReference1 (did: string, eid: string, wvm: string, wvmid: string, rid: string, bTAppElementReferenceParams: BTAppElementReferenceParams) : Promise<{ response: http.IncomingMessage; body: BTAppElementReferenceInfo;  }> {
        const localVarPath = this.basePath + '/api/appelements/d/{did}/{wvm}/{wvmid}/e/{eid}/references/{rid}'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
