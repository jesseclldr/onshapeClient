...
export class DefaultApi {
     ...
     */
    public addFeature1 (did: string, wvm: string, wvmid: string, eid: string, body?: string) : Promise<{ response: http.IncomingMessage; body: BTFeatureDefinitionResponse;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTFeatureDefinitionResponse;  }>((resolve, reject) => {
     ...
     */
    public createPartStudio (did: string, wid: string, bTModelElementParams: BTModelElementParams) : Promise<{ response: http.IncomingMessage; body: BTDocumentElementInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTDocumentElementInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public exportPS1 (did: string, wvm: string, wvmid: string, eid: string, partIds?: string, version?: string, includeExportIds?: boolean, configuration?: string, linkDocumentId?: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param linkDocumentId Id of document that links to the document being accessed. This may provide additional access rights to the document. Allowed only with version (v) path parameter.
     */
    public getBodyDetails2 (did: string, wvm: string, wvmid: string, eid: string, configuration?: string, linkDocumentId?: string) : Promise<{ response: http.IncomingMessage; body: Array<BTExportModelBodiesResponse>;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<BTExportModelBodiesResponse>;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param linkDocumentId Id of document that links to the document being accessed. This may provide additional access rights to the document. Allowed only with version (v) path parameter.
     */
    public getBoundingBoxes2 (did: string, wvm: string, wvmid: string, eid: string, includeHidden?: boolean, includeWireBodies?: boolean, configuration?: string, linkDocumentId?: string) : Promise<{ response: http.IncomingMessage; body: BTBoundingBox;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTBoundingBox;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getEdges2 (did: string, wvm: string, wvmid: string, eid: string, angleTolerance?: number, chordTolerance?: number, partId?: Array<string>, edgeId?: Array<string>, configuration?: string, linkDocumentId?: string) : Promise<{ response: http.IncomingMessage; body: BTExportTessellatedEdgesResponse;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTExportTessellatedEdgesResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
    ...
    public getFaces2 (did: string, wvm: string, wvmid: string, eid: string, angleTolerance?: number, chordTolerance?: number, maxFacetWidth?: number, outputVertexNormals?: boolean, outputFacetNormals?: boolean, outputTextureCoordinates?: boolean, outputIndexTable?: boolean, partId?: Array<string>, faceId?: Array<string>, outputErrorFaces?: boolean, configuration?: string, linkDocumentId?: string) : Promise<{ response: http.IncomingMessage; body: BTExportTessellatedFacesResponse;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTExportTessellatedFacesResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getFeatures (did: string, wvm: string, wvmid: string, eid: string, featureId?: Array<string>, linkDocumentId?: string, noSketchGeometry?: boolean) : Promise<{ response: http.IncomingMessage; body: BTFeatureListResponse;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/features'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
            .replace('{' + 'wvmid' + '}', encodeURIComponent(String(wvmid)))
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTFeatureListResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param linkDocumentId Id of document that links to the document being accessed. This may provide additional access rights to the document. Allowed only with version (v) path parameter.
     */
    public getMassProperties (did: string, wvm: string, wvmid: string, eid: string, partId?: Array<string>, massAsGroup?: boolean, configuration?: string, linkDocumentId?: string) : Promise<{ response: http.IncomingMessage; body: BTMassPropResponse;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTMassPropResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getNamedViews2 (did: string, eid: string, skipPerspective?: boolean) : Promise<{ response: http.IncomingMessage; body: BTNamedViewsInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTNamedViewsInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getOpenApi (fileType?: 'json' | 'yaml', excludedTags?: string, includedTags?: string, documentationStatus?: Array<'DEVELOPMENT' | 'PRODUCTION' | 'STAGING' | 'EVP' | 'UNSET' | 'INTERNAL'>) : Promise<{ response: http.IncomingMessage; body: OpenAPI;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: OpenAPI;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
    ...
    public getShadedViews1 (did: string, wvm: string, wvmid: string, eid: string, viewMatrix?: string, outputHeight?: number, outputWidth?: number, pixelSize?: number, edges?: string, showAllParts?: boolean, includeSurfaces?: boolean, useAntiAliasing?: boolean, configuration?: string, linkDocumentId?: string) : Promise<{ response: http.IncomingMessage; body: BTShadedRenderDocumentResponse;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTShadedRenderDocumentResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getTranslatorFormats4 (did: string, wid: string, eid: string, checkContent?: boolean) : Promise<{ response: http.IncomingMessage; body: Array<BTModelFormatInfo>;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<BTModelFormatInfo>;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public translateFormat5 (did: string, wv: string, wvid: string, eid: string, bTTranslateFormatParams: BTTranslateFormatParams) : Promise<{ response: http.IncomingMessage; body: BTTranslationRequestInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTTranslationRequestInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public translateIds1 (did: string, wvm: string, wvmid: string, eid: string, bTIdTranslationParams: BTIdTranslationParams) : Promise<{ response: http.IncomingMessage; body: BTIdTranslationInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTIdTranslationInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
