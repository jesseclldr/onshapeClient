...
export class AccountsApi {
     ...
     */
    public cancelPurchaseNew (aid: string, pid: string, cancelImmediately?: boolean) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public consumePurchase (pid: string, bTPurchaseUserParams?: BTPurchaseUserParams) : Promise<{ response: http.IncomingMessage; body: BTPurchaseInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTPurchaseInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param limit 
     */
    public getPlanPurchases (planId: string, offset?: number, limit?: number) : Promise<{ response: http.IncomingMessage; body: BTListResponseBTPurchaseInfo;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: BTListResponseBTPurchaseInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getPurchases (all?: boolean, ownPurchaseOnly?: boolean) : Promise<{ response: http.IncomingMessage; body: Array<BTPurchaseInfo>;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<BTPurchaseInfo>;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
