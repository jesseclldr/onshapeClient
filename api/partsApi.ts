...
export class PartsApi {
     ...
     */
    public getPartsWMV (did: string, wvm: string, wvmid: string, elementId?: string, withThumbnails?: boolean, includePropertyDefaults?: boolean, linkDocumentId?: string, configuration?: string) : Promise<{ response: http.IncomingMessage; body: Array<BTPartMetadataInfo>;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<BTPartMetadataInfo>;  }>((resolve, reject) => {
     ...
     * @param body 
     */
    public updatePartsWMV (did: string, wvm: string, wvmid: string, editDescription?: string, body?: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/parts/d/{did}/{wvm}/{wvmid}'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
            .replace('{' + 'wvmid' + '}', encodeURIComponent(String(wvmid)));
